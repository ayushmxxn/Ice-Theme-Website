...
const Theme = () => {
  ...
  return (
    <div id='ThemeSection' className={`${isMobile ? "bg-gradient-to-b from-sky-500 via-sky-600 to-sky-600" : "bg-gradient-to-b from-sky-500 via-violet-600 to-violet-600"} py-12 sm:py-20`}>
