...
const Theme = () => {
  ...
  return (
    <div id='ThemeSection' className={`${isMobile ? "bg-gradient-to-b from-sky-500 via-indigo-600 to-indigo-600" : "bg-gradient-to-b from-sky-500 via-violet-600 to-violet-600"} py-12 sm:py-20`}>
