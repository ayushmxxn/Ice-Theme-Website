    ...
    <div className={`w-full max-w-screen-xl mx-auto p-4 md:py-8 `}>
        <div className="sm:flex sm:items-center sm:justify-between">
            <a href="#MainPage" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                ...
                <span className={`self-center text-2xl font-semibold whitespace-nowrap text-white ${Nunito.className}`}>Ice Theme</span>
            </a>
        ...
        <span className="block text-sm  sm:text-center text-gray-400">© 2024 Ice Theme™. All Rights Reserved.</span>
    </div>
    </footer>
     </div>
  )
