  ...
  return (
    <div className="relative w-full h-[600px]  flex flex-col items-center justify-center overflow-hidden rounded-md">
      ...
      <div id='Get Theme Button' onClick={()=> openExtensionPage()}>
        <button className="cursor-pointer relative bottom-8 sm:bottom-8 text-black inline-flex items-center justify-center whitespace-nowrap font-semibold px-4 py-3 leading-none border-none rounded-md shadow-md bg-gradient-to-br from-white to-blue-400">
          Add to VS Code
        </button>
      </div>
    </div>
